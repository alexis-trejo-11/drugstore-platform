...
@ApiResponses(value = {
    ...
    @ApiResponse(responseCode = "404", description = "Product not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ResponseWrapper.class), examples = @ExampleObject(name = "Not Found Example", value = """
        ...
        """))),
    @ApiResponse(responseCode = "400", description = "Bad Request - Invalid barcode format", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ResponseWrapper.class), examples = @ExampleObject(name = "Bad Request Barcode", value = """
        {
          "success": false,
