...
@Operation(
    ...
    description =
        "Triggers outbound email with reset instructions. Response is generic to avoid email "
            + "enumeration **(same shape whether or not the email exists)**.")
@ApiResponses({
  @ApiResponse(
      responseCode = "200",
      description = "Request accepted (check email if account exists).",
      content =
          @Content(
