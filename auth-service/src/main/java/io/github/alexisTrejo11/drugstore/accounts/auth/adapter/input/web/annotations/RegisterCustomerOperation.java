...
@Operation(
    ...
    description =
        "Creates a **CUSTOMER** account (subject to domain validation and uniqueness rules).")
@ApiResponses({
  @ApiResponse(
      responseCode = "201",
  ...
  @ApiResponse(
      responseCode = "409",
      description = "Conflict — e.g. email or phone already registered.",
      content =
          @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = AuthOpenApiModels.ErrorPayload.class))),
...
public @interface RegisterCustomerOperation {}
