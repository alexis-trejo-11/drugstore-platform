...
@Operation(
    ...
    description =
        "Validates a one-time code for the authenticated user (e.g. before sensitive action). "
            + "Uses the same body schema as `/confirm`.")
@ApiResponses({
  @ApiResponse(
      responseCode = "200",
...
public @interface VerifyTwoFactorCodeOperation {}
