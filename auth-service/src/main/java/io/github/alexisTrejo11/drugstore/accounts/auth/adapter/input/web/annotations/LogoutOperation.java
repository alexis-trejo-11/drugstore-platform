...
@Operation(
    operationId = "logout",
    summary = "Logout (single refresh session)",
    description =
        "Revokes the given refresh token. Does **not** require `Authorization` — identify the "
            + "session via body only.")
@ApiResponses({
  @ApiResponse(
      responseCode = "200",
  ...
  @ApiResponse(
      responseCode = "400",
      description = "Unknown token or validation error.",
      content =
          @Content(
              mediaType = "application/json",
