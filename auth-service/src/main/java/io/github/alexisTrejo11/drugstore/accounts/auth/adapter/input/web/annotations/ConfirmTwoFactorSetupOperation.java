...
@Operation(
    ...
    description =
        "Submits the first valid TOTP after `/enable` to persist 2FA as **enabled** for the account.")
@ApiResponses({
  @ApiResponse(
      responseCode = "200",
  ...
  @ApiResponse(
      responseCode = "400",
      description = "Wrong code or setup expired.",
      content =
          @Content(
              mediaType = "application/json",
...
public @interface ConfirmTwoFactorSetupOperation {}
