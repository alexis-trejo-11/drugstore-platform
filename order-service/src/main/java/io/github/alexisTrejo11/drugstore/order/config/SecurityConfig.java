...
import io.github.alexisTrejo11.drugstore.order.config.security.RestAccessDeniedHandler;
import io.github.alexisTrejo11.drugstore.order.config.security.RestAuthenticationEntryPoint;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
				...
				.authorizeHttpRequests(authorize -> authorize
						...
						.requestMatchers("/api/v2/orders/**").hasAnyRole("ADMIN", "MANAGER")
						.requestMatchers("/api/v2/customers/**").hasAnyRole("ADMIN", "MANAGER", "CUSTOMER")
