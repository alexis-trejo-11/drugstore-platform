package io.github.alexisTrejo11.drugstore.order.orders.presentation.annotation;
...
@ApiResponses({
    @ApiResponse(responseCode = "201", description = "PurchaseOrder created", content = @Content(mediaType = "application/json", schema = @Schema(implementation = CreateOrderOperationSummary.class), examples = @ExampleObject(name = "CreateOrderSuccess", value = """
        {
          "success": true,
          "code": 201,
