package io.github.alexisTrejo11.drugstore.order.external.address.model;
...
public record DeliveryAddressResponse(
        ...
        @JsonProperty("inner_number") String innerNumber,

        @JsonProperty("outer_number") String outerNumber,

        String neighborhood,

        @JsonProperty("building_type") BuildingType buildingType,

        String city,

        @NotBlank(message = "State is required") String state,

        @NotBlank(message = "Zip code is required") @JsonProperty("zip_code") String zipCode,
