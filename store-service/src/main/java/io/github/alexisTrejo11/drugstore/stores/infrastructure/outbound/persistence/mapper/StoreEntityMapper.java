package io.github.alexisTrejo11.drugstore.stores.infrastructure.outbound.persistence.mapper;
...
import io.github.alexisTrejo11.drugstore.stores.infrastructure.outbound.persistence.entity.AddressEmbeddable;
import io.github.alexisTrejo11.drugstore.stores.infrastructure.outbound.persistence.entity.StoreEntity;
...
public class StoreEntityMapper implements ModelMapper<Store, StoreEntity> {
	...
	public StoreEntity fromDomain(Store domain) {
		...
		entity.setLatitude(BigDecimal.valueOf(geolocation.latitude()));
		entity.setLongitude(BigDecimal.valueOf(geolocation.longitude()));
