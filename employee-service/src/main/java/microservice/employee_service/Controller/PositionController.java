...
public class PositionController {
    ...
    public ResponseEntity<ResponseWrapper<?>> createPosition(@Valid @RequestBody PositionInsertDTO positionInsertDTO, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            ...
            return ResponseEntity.badRequest().body(new ResponseWrapper<>(false, validationErrors, "Validation Error", HttpStatus.BAD_REQUEST.value()));
        }
    ...
    public ResponseEntity<ResponseWrapper<?>> updatePosition(@Valid @RequestBody PositionUpdateDTO positionUpdateDTO, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            var validationErrors = ControllerValidation.handleValidationError(bindingResult);
