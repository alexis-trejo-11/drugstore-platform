...
public class OpenApiConfig {
        ...
        @Bean
        public OpenAPI inventorieserviceOpenAPI() {
                // "/" resolves against the browser origin where Swagger UI is opened — avoids
                // wrong
                // scheme/port (e.g. https://localhost vs http://localhost:8084) and “Failed to
                // fetch”.
                ...
                Server prodServer = new Server()
                                .url("https://api.ecommerce.com/inventory-service")
                                .description("Production");

                return new OpenAPI()
                                .info(new Info()
                                                .title("inventory Service API")
                                                .description("Drugstore Microservice for managing inventories in the e-commerce platform")
                                                .version("2.0.0")
                                                .contact(new Contact()
                                                                .name("Alexis Trejo")
